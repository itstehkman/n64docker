...
reserved = [0x1b, 0x11e, 0x120, 0x0, 0x122, 0x123, 0x125, 0x70, 0x6d, 0x5d, 0x5b, 0x66, 0x2f, 0x133, 0x134,
            0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39]

no_equivalent = [0x10a, 0x140, 0x10d, 0x10e]
not_supported = [0x126, 0x127, 0x128, 0x142, 0xc, 0x13f, 0x13d]
...
sdl_keycodes = sdl_keycodes.select{|n| !reserved.include?(n) && !no_equivalent.include?(n) && !not_supported.include?(n)}
